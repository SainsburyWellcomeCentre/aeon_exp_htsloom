...
namespace HtsLoom
{
    ...
    public enum EventName
    {
        ...
        [System.Runtime.Serialization.EnumMemberAttribute(Value="Key5Event")]
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="Key5Event")]
        Key5Event = 6,
    
        [System.Runtime.Serialization.EnumMemberAttribute(Value="Key6Event")]
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="Key6Event")]
        Key6Event = 7,
    
        [System.Runtime.Serialization.EnumMemberAttribute(Value="Key7Event")]
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="Key7Event")]
        Key7Event = 8,
    
        [System.Runtime.Serialization.EnumMemberAttribute(Value="Key8Event")]
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="Key8Event")]
        Key8Event = 9,
    
        [System.Runtime.Serialization.EnumMemberAttribute(Value="Key9Event")]
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="Key9Event")]
        Key9Event = 10,
    
        [System.Runtime.Serialization.EnumMemberAttribute(Value="Key0Event")]
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="Key0Event")]
        Key0Event = 11,
    ...
    public partial class Task
    {
        ...
        private System.Collections.Generic.Dictionary<string, FeederABCMetaController> _feederTask;
        ...
        public Task()
        {
            ...
            _feederTask = new System.Collections.Generic.Dictionary<string, FeederABCMetaController>();
        }
        ...
        /// <summary>
        /// Feeder ABC meta-state players keyed by an arbitrary player/lane id (e.g. a screen, coordinate, or subject). The feeders each player drives are defined by the patchStates in its referenced state files, not by this key.
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        ...
        [System.ComponentModel.DescriptionAttribute("Feeder ABC meta-state players keyed by an arbitrary player/lane id (e.g. a screen" +
            ", coordinate, or subject). The feeders each player drives are defined by the pat" +
            "chStates in its referenced state files, not by this key.")]
        public System.Collections.Generic.Dictionary<string, FeederABCMetaController> FeederTask
        {
            get
            {
                return _feederTask;

...
parser = argparse.ArgumentParser(
    description="Moves data files from the specified source folder to a remote storage folder."
)
...
process = subprocess.run(["robocopy", source, destination] + robocopy_parameters, shell=True)
